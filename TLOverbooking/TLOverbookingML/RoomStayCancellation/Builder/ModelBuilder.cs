...
namespace TLOverbookingML.RoomStayCancellation.Builder
{
    public static class ModelBuilder
    {
        ...
        private static void Evaluate( MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline )
        {
            ...
            var crossValidationResults = mlContext.MulticlassClassification.CrossValidate( trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "IsCancelled" );
